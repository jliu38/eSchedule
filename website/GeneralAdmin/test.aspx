<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="test.aspx.cs" Inherits="GeneralAdmin_test" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <asp:ListView ID="ListView1" runat="server" DataSourceID="TestObjectDataSource" InsertItemPosition="FirstItem" DataKeyNames="LocationID">
    ...
    <asp:ObjectDataSource runat="server" ID="TestObjectDataSource" DataObjectTypeName="eSchedule.Entities.Location" InsertMethod="AddLocation" OldValuesParameterFormatString="original_{0}" SelectMethod="ListAllLocationss" TypeName="eSchedule.BLL.ScheduleControll" UpdateMethod="UpdateLocation" DeleteMethod="DeleteLocation"></asp:ObjectDataSource>
</asp:Content>
